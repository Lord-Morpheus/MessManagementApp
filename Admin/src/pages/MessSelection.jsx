...
export default function Selection() {
  ...
  const sendNotification = async () => {
    ...
    try {
      setSending(true);
      await axios.post(
        `${import.meta.env.VITE_BACKEND_URI}/admin/notification`,
        {
        ...
        <div className="px-6 py-6">
          <div className="flex flex-col items-center rounded shadow-md">
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <button
                disabled={sending}
                className="bg-[#012069dd] hover:bg-[#012169] text-white font-bold py-2 px-4 mx-2 rounded-full disabled:cursor-not-allowed disabled:opacity-50"
                onClick={() => {
                  sendNotification();
                }}
              >
