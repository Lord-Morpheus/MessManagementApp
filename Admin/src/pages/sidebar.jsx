...
export default function Sidebar() {
  ...
  return (
    <div className="flex flex-col items-center bg-white min-h-lvh">
      ...
      <div className="flex flex-col justify-center items-start">
        ...
        <div className="input-group flex items-center mb-2">
          ...
          <Link className="text-decoration-none" to="/menu">
            <span className="ml-3 text-dark text-lg">Mess Menu</span>
          </Link>
        </div>
        <div className="input-group flex items-center mb-2">
          <i className="bi bi-building-fill ml-1">
          ...
          <Link className="text-decoration-none">
            <span className="ml-3 text-dark text-lg">Registraion Details</span>
          </Link>
        </div>
        {/* <div className="input-group flex items-center mb-2">
