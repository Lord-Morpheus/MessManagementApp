...
//     // Iterate over each mess
//     for (const mess of messes) {
//       // Calculate revenue for each mess
//       let revenue = 0;
//       for (const student of mess.students) {
//         // Calculate revenue generated by each student (daysPresent * 125)
//         const studentRevenue = student.daysPresent * 125;
//         // Add student revenue to total revenue
//         revenue += studentRevenue;
//       }

//       // Push mess revenue data to the data array
//       data.push({ name: mess.name, revenue }); // Assuming mess has a name field
//     }
...
//         {
//           name: "Revenue(in INR) ",
//           data: data.map((mess) => mess.revenue),
//         },
//       ],
//       options: {
//         chart: {
